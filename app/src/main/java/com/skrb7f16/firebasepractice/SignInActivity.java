...
import com.skrb7f16.firebasepractice.databinding.ActivitySigninBinding;
...
public class SignInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signinBinding.tvClickSignup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent intent=new Intent(SignInActivity.this,MainActivity.class);
                            startActivityForResult(intent,22);
                            Toast.makeText(SignInActivity.this,"Sigin complete",Toast.LENGTH_SHORT).show();
//                            updateUI(user);
                        } else {
